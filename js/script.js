...
$(document).ready(function () {
	...
	$('.login-form__btn').click(function (event) {
		...
		var address = document.forms['login_form'].elements['login_mail'].value;
		if (document.login_form.login_mail.value == "" || document.login_form.login_pass.value == "" || reg.test(address) == false) {
			if (document.login_form.login_mail.value == "") { document.login_form.login_mail.classList.add('_empty'); $('.login-form__empty').addClass('_err'); } else { document.login_form.login_mail.classList.remove('_empty'); $('.login-form__empty').removeClass('_err'); };
			if (document.login_form.login_pass.value == "") { document.login_form.login_pass.classList.add('_empty'); $('.login-form__empty').addClass('_err'); } else { document.login_form.login_pass.classList.remove('_empty'); $('.login-form__empty').removeClass('_err'); };
			if (reg.test(address) == false) { $('.login-form__mail-ucorrect').addClass('_active'); document.login_form.login_mail.classList.add('_empty'); } else { $('.login-form__mail-ucorrect').removeClass('_active') };
			event.preventDefault();
		} else {
